			...
			<swiper-item class="swiper-item" v-for="(item, index) in list" :key="index">
				<!-- 自定义组件-->
						<view class="orderContent">
							<!-- 自定义组件-->
							<SwiperShareOrderList :tabIndex="index" :currentIndex="currentIndex" @deleteModelShow2="$emit('deleteModelShow3')"></SwiperShareOrderList>
...
<script>
	...
	import SwiperShareOrderList from '@/pages/TabBar/Order/components/SwiperShareOrderList.vue'
	export default {
		components: {
			OrderItem,
			SwiperShareOrderList
		},
		props: {
			list: {
				type: Array,
		...
		data() {
			return {
				...
				//点击的tab索引
				currentIndex: 0,
				lineBg: 'https://gitee.com/qiuyuqiuyu/picgo/raw/master/images/21选择@2x.png',//订单列表
				top:'232rpx',
				isIphoneXup:false
			}
		},
